...
async function registerClockIn(employeeId: employeeId, clockInStatus: ClockInStatus): Promise<void> {

    const req = await fetch(`https://api.freee.co.jp/api/v1/employees/${employeeId}/time_clocks`,
        {
